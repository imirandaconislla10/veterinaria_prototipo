    ...
    <div class="card-body">
     <div class="card-content p-2">
      <div class="card-title text-uppercase pb-2">RESTABLECER LA CONTRASEÑA</div>
        <p class="pb-2">Por favor, introduzca su dirección de correo electrónico nuevamente</p>
        <form action="conexiones/validar_recuperacion_datos.php" method="post">
        ...
        <div class="form-group">
        <label for="exampleInputEmailAddress" class="">TELEFONO</label>
         <div class="position-relative has-icon-right">
          <input type="number" name="telefono" class="form-control input-shadow" placeholder="telefono">
          <div class="form-control-position">
