...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="row">
            <div class="col-sm-9">
            <i class="fa fa-table"></i> Eliminar Medicina
            </div>
            <div class="col-sm-3">
    ...
    echo "<tr>";
		echo "<th>Nombre del medicamento</th>";
		echo "<th>Descripción del medicamento</th>";
		echo "<th>Cantidad</th>";
		echo "<th>Grado de recomendación</th>";
    ...
    echo "</tr>";
  	echo "</thead>";
          ...
          echo "<td><a href='veterinaria_medicinas_eliminar.php?id=$arreglo[0]&idborrar=2'><img src='assets/images/iconos/eliminar.png' width='50'/></a></td>";
        ...
        extract($_GET);
          if(@$idborrar==2){
            ...
            $sqlborrar="DELETE FROM medicamentos WHERE id=$id";
            $resborrar=mysqli_query($mysqli,$sqlborrar);
            echo "<script>location.href='veterinaria_medicinas_eliminar.php'</script>";
          }
