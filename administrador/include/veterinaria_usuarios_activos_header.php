...
?>
     ...
     <li class="nav-item dropdown-lg">
      <a class="nav-link dropdown-toggle dropdown-toggle-nocaret waves-effect" data-toggle="dropdown" href="javascript:void();">
    <i class="fa fa-key"></i><span class="badge badge-info badge-up">
...
if ($result = $mysqli->query("SELECT id FROM recuperar ORDER BY id")) {
      ...
      <div class="dropdown-menu dropdown-menu-right">
        <ul class="list-group list-group-flush">
          ...
          Restablecer contraseña
                  ...
                  $sql="SELECT * FROM recuperar WHERE `id` = id ORDER BY `ID` ASC";
                  $ressql=mysqli_query($mysqli,$sql);
                  while ($row=mysqli_fetch_row ($ressql)){
                ...
                <li class="list-group-item">
                <div class="media">
                <img src="assets/images/icono.png" class="img-circle" width="30">
                <div class="media-body">
                <h6 class="mt-0 msg-title">'.htmlentities($id).'</h6>
                <a href="veterinaria_recuperar"><p class="msg-info">'.htmlentities($correo).'</p></a>
                </div>
                </div>
                </a>
                </li>
