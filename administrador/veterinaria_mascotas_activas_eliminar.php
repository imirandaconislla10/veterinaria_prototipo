        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-header">
              <div class="row">
              <div class="col-sm-9">
              <i class="fa fa-table"></i> Eliminar Mascotas 
              </div>
              <div class="col-sm-3">
      ...
      <?php 
         while($arreglo=mysqli_fetch_array($query)){
            ...
            echo "<tr>";
              ...
              echo "<td><a href='veterinaria_mascotas_activas_eliminar?id=$arreglo[1]&idborrar=2'><img src='assets/images/iconos/eliminar.png' width='50'/></button></a></td>";
        ...
        extract($_GET);
          if(@$idborrar==2){
            ...
            $sqlborrar="DELETE FROM mascotas WHERE id=$id";
            $resborrar=mysqli_query($mysqli,$sqlborrar);
            echo "<script>location.href='veterinaria_mascotas_activas.php'</script>";
          }
