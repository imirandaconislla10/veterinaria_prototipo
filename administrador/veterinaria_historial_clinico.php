			...
			<?php 
				 while($arreglo=mysqli_fetch_array($query)){
				  	...
				  	echo "<tr>";
				    	...
				    	echo "<td><img src='img/uploads/$arreglo[7]' style='width: 50px; height: 50px;'></td>";
				    	echo "<td><img src='img/uploads/$arreglo[8]' style='width: 50px; height: 50px;'></td>";
              echo "<td><img src='img/uploads/$arreglo[9]' style='width: 50px; height: 50px;'></td>";
