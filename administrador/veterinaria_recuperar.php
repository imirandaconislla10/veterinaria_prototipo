      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-header">
            	<div class="row">
            	<div class="col-sm-9">
            	<i class="fa fa-table"></i> Recuperar Contraseñas
            	</div>
            	<div class="col-sm-3">
       			<div class="btn-group float-sm-right">
       			<a href="veterinaria_recuperar"><button type="button" class="btn btn-light waves-effect waves-light"><i class="fa fa-database"></i> Recuperar Contraseña</button></a>
       			</div>
      			</div>
      			</div>
            </div>
			...
			<?php 
              ...
              echo "<td><a href='veterinaria_recuperar?id=$arreglo[1]&idborrar=2'><img src='assets/images/iconos/eliminar.png' width='50'/></a></td>";
        ...
        extract($_GET);
          if(@$idborrar==2){
            ...
            $sqlborrar="DELETE FROM recuperar WHERE id=$id";
            $resborrar=mysqli_query($mysqli,$sqlborrar);
            echo "<script>location.href='veterinaria_recuperar'</script>";
          }
